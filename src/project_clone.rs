...
fn repository_key(repository: &GitHubRepository) -> String {
    let mut hasher = Sha256::new();
    hasher.update(b"codex-free/github-repository/v1\0");
    hasher.update(repository.identity.as_bytes());
