    ...
    fn input_schema(&self) -> Value {
        json!({
            ...
            "properties": {
                ...
                "advance": {
                    "type": "boolean",
                    "description": "Record the emitted snapshot as the next incremental baseline. This changes only Codex Free's private diff cursor. Default: true."
                },
                "include_patch": {
                    "type": "boolean",
