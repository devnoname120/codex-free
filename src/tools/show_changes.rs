...
impl Tool for ShowChanges {
    ...
    fn behavior(&self) -> ToolBehavior {
        ToolBehavior::new(
            ...
            true,
            false,
            "Presents project state and updates only Codex Free's private incremental-delivery cursor; it does not modify project files, Git history, user-owned data, or external systems.",
        )
    }
    ...
    fn input_schema(&self) -> Value {
        json!({
            ...
            "properties": {
                ...
                "advance": {
                    "type": "boolean",
                    "description": "Record the emitted snapshot as the next incremental baseline. This changes only Codex Free's private review cursor. Default: true."
                },
                "include_patch": {
                    "type": "boolean",
