...
pub const CHILD_CONTROL_PLANE_API_KEY_ENV: &str = "CODEX_FREE_OPENAI_TUNNEL_API_KEY";
pub const CHILD_MCP_AUTHORIZATION_ENV: &str = "CODEX_FREE_INTERNAL_MCP_AUTHORIZATION";
