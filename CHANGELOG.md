...
- **Breaking connector-schema rename:** the Codex Free diff-display tool is now
  ...
  New persistent checkpoints live under `refs/codex-free/diff/` with a
  `last-diff` ref, while existing `refs/codex-free/review/.../last-review` state is
