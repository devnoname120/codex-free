...
conversation identity and persist two refs under `refs/codex-free/diff/`; generic
...
`refs/codex-free/review/.../project-open` and `.../last-review` refs are copied lazily
