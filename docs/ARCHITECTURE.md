...
3. Verify the official release archive against the per-platform SHA-256 embedded
   in the Codexrr build, install the exact expected executable atomically with
