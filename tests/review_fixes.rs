...
use codex_free::exec_sessions::{SessionState, ShellType, resolve_shell, shell_type_of};
use codex_free::tool::{Tool, arg_u64};
...
fn find_skill_is_unicode_case_insensitive() {
    ...
    let catalog = codex_free::skills::discover_skills(&config);
